...
namespace Mozilla.Test
{
  ...
  public interface IDocHostUIHandler
  {
    ...
    [PreserveSig] void GetExternal([MarshalAs(UnmanagedType.IDispatch)] out object ppDispatch);
    ...
    [PreserveSig] uint ShowContextMenu(uint dwID, ref tagPOINT ppt,
    ...
    [PreserveSig] uint TranslateUrl(uint dwTranslate, 
