...
public class WebBrowser_V1Class : DWebBrowserEvents_Event, DWebBrowserEvents2_Event, IWebBrowser, IWebBrowser2, IWebBrowserApp, WebBrowser_V1 {
	
	public WebBrowser_V1Class ();
	...
	public virtual void add_CommandStateChange (DWebBrowserEvents_CommandStateChangeEventHandler );
	public virtual void add_DocumentComplete (DWebBrowserEvents2_DocumentCompleteEventHandler );
	public virtual void add_DownloadBegin (DWebBrowserEvents_DownloadBeginEventHandler );
	public virtual void add_DownloadComplete (DWebBrowserEvents_DownloadCompleteEventHandler );
	...
	public virtual void add_ProgressChange (DWebBrowserEvents_ProgressChangeEventHandler );
	public virtual void add_PropertyChange (DWebBrowserEvents_PropertyChangeEventHandler );
	...
	public virtual void add_StatusTextChange (DWebBrowserEvents_StatusTextChangeEventHandler );
	public virtual void add_TitleChange (DWebBrowserEvents_TitleChangeEventHandler );
	...
	public virtual void DWebBrowserEvents2_Event_add_CommandStateChange (DWebBrowserEvents2_CommandStateChangeEventHandler );
	public virtual void DWebBrowserEvents2_Event_add_DownloadBegin (DWebBrowserEvents2_DownloadBeginEventHandler );
	public virtual void DWebBrowserEvents2_Event_add_DownloadComplete (DWebBrowserEvents2_DownloadCompleteEventHandler );
	public virtual void DWebBrowserEvents2_Event_add_ProgressChange (DWebBrowserEvents2_ProgressChangeEventHandler );
	public virtual void DWebBrowserEvents2_Event_add_PropertyChange (DWebBrowserEvents2_PropertyChangeEventHandler );
	public virtual void DWebBrowserEvents2_Event_add_StatusTextChange (DWebBrowserEvents2_StatusTextChangeEventHandler );
	public virtual void DWebBrowserEvents2_Event_add_TitleChange (DWebBrowserEvents2_TitleChangeEventHandler );
	public virtual void DWebBrowserEvents2_Event_remove_CommandStateChange (DWebBrowserEvents2_CommandStateChangeEventHandler );
	public virtual void DWebBrowserEvents2_Event_remove_DownloadBegin (DWebBrowserEvents2_DownloadBeginEventHandler );
	public virtual void DWebBrowserEvents2_Event_remove_DownloadComplete (DWebBrowserEvents2_DownloadCompleteEventHandler );
	public virtual void DWebBrowserEvents2_Event_remove_ProgressChange (DWebBrowserEvents2_ProgressChangeEventHandler );
	public virtual void DWebBrowserEvents2_Event_remove_PropertyChange (DWebBrowserEvents2_PropertyChangeEventHandler );
	public virtual void DWebBrowserEvents2_Event_remove_StatusTextChange (DWebBrowserEvents2_StatusTextChangeEventHandler );
	public virtual void DWebBrowserEvents2_Event_remove_TitleChange (DWebBrowserEvents2_TitleChangeEventHandler );
	...
	public virtual void IWebBrowser2_GoBack ();
	public virtual void IWebBrowser2_GoForward ();
	public virtual void IWebBrowser2_GoHome ();
	public virtual void IWebBrowser2_GoSearch ();
	public virtual void IWebBrowser2_Navigate (string URL, ref object Flags, ref object TargetFrameName, ref object PostData, ref object Headers);
	public virtual void IWebBrowser2_Refresh ();
	public virtual void IWebBrowser2_Refresh2 (ref object Level);
	public virtual void IWebBrowser2_Stop ();
	...
	public virtual void remove_CommandStateChange (DWebBrowserEvents_CommandStateChangeEventHandler );
	public virtual void remove_DocumentComplete (DWebBrowserEvents2_DocumentCompleteEventHandler );
	public virtual void remove_DownloadBegin (DWebBrowserEvents_DownloadBeginEventHandler );
	public virtual void remove_DownloadComplete (DWebBrowserEvents_DownloadCompleteEventHandler );
	...
	public virtual void remove_ProgressChange (DWebBrowserEvents_ProgressChangeEventHandler );
	public virtual void remove_PropertyChange (DWebBrowserEvents_PropertyChangeEventHandler );
	...
	public virtual void remove_StatusTextChange (DWebBrowserEvents_StatusTextChangeEventHandler );
	public virtual void remove_TitleChange (DWebBrowserEvents_TitleChangeEventHandler );
	...
	public virtual object IWebBrowser2_Application {
		get;
	}
	public virtual bool IWebBrowser2_Busy {
		get;
	}
	public virtual object IWebBrowser2_Container {
		get;
	}
	public virtual object IWebBrowser2_Document {
		get;
	}
	public virtual int IWebBrowser2_Height {
		get;
		set;
	}
	public virtual int IWebBrowser2_Left {
		get;
		set;
	}
	public virtual string IWebBrowser2_LocationName {
		get;
	}
	public virtual string IWebBrowser2_LocationURL {
		get;
	}
	public virtual object IWebBrowser2_Parent {
		get;
	}
	public virtual int IWebBrowser2_Top {
		get;
		set;
	}
	public virtual bool IWebBrowser2_TopLevelContainer {
		get;
	}
	public virtual string IWebBrowser2_Type {
		get;
	}
	public virtual int IWebBrowser2_Width {
		get;
		set;
	}
	...
	public event DWebBrowserEvents_CommandStateChangeEventHandler CommandStateChange;
	public event DWebBrowserEvents2_DocumentCompleteEventHandler DocumentComplete;
	public event DWebBrowserEvents_DownloadBeginEventHandler DownloadBegin;
	public event DWebBrowserEvents_DownloadCompleteEventHandler DownloadComplete;
	public event DWebBrowserEvents_QuitEventHandler DWebBrowserEvents_Event_Quit;
	public event DWebBrowserEvents2_CommandStateChangeEventHandler DWebBrowserEvents2_Event_CommandStateChange;
	public event DWebBrowserEvents2_DownloadBeginEventHandler DWebBrowserEvents2_Event_DownloadBegin;
	public event DWebBrowserEvents2_DownloadCompleteEventHandler DWebBrowserEvents2_Event_DownloadComplete;
	public event DWebBrowserEvents2_ProgressChangeEventHandler DWebBrowserEvents2_Event_ProgressChange;
	public event DWebBrowserEvents2_PropertyChangeEventHandler DWebBrowserEvents2_Event_PropertyChange;
	public event DWebBrowserEvents2_StatusTextChangeEventHandler DWebBrowserEvents2_Event_StatusTextChange;
	public event DWebBrowserEvents2_TitleChangeEventHandler DWebBrowserEvents2_Event_TitleChange;
	...
	public event DWebBrowserEvents_ProgressChangeEventHandler ProgressChange;
	public event DWebBrowserEvents_PropertyChangeEventHandler PropertyChange;
	public event DWebBrowserEvents2_SetSecureLockIconEventHandler SetSecureLockIcon;
	public event DWebBrowserEvents_StatusTextChangeEventHandler StatusTextChange;
	public event DWebBrowserEvents_TitleChangeEventHandler TitleChange;
